...
public class MovieTestData {
    ...
    public static List<Movie> getTestMovies() {
        ...
        movies.add(new Movie("102103", "Inception", List.of("Leonardo DiCaprio", "Joseph Gordon-Levitt", "Ellen Page"), "Science Fiction", 148, "PG-13", "A young boy and his little sister struggle to survive in Japan during World War II.", "1.jpg", 78.00, 2024, 4.0, 1, false, 0));
        movies.add(new Movie("001301", "The Dark Knight", List.of("Christian Bale", "Heath Ledger", "Aaron Eckhart"), "Action", 152, "PG-13", "A human soldier is sent from 2029 to 1984 to stop an almost indestructible cyborg killing machine, sent from the same year, which has been programmed to execute a young woman whose unborn son is the key to humanity's future salvation..", "2.jpg", 60.00,2023, 4.2,10,true, 1));
        ...
        movies.add(new Movie("002102", "The Dark Knight", List.of("Christian Bale", "Heath Ledger", "Aaron Eckhart"), "Action", 152, "PG-13", "A young boy and his little sister struggle to survive in Japan during World War II..", "1.jpg", 60.00,2023, 4.5, 1, true, 1));
